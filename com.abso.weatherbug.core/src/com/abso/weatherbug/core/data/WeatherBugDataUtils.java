...
public class WeatherBugDataUtils {
    ...
    public static Timestamp getTimestamp(Element elem, String path) {
        ...
        Calendar cal = new GregorianCalendar(WeatherBugDataUtils.getInt(timestampElem, "aws:year/@number", -1), WeatherBugDataUtils
                .getInt(timestampElem, "aws:month/@number", -1), WeatherBugDataUtils.getInt(timestampElem, "aws:day/@number", -1),
                WeatherBugDataUtils.getInt(timestampElem, "aws:hour/@hour-24", -1), WeatherBugDataUtils.getInt(timestampElem,
                        "aws:minute/@number", -1), WeatherBugDataUtils.getInt(timestampElem, "aws:second/@number", -1));
